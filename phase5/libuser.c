 ...
 *
 */
int Spawn(char *name, int (*func)(void *), void *arg, int stack_size, int priority, 
	int *pid)   
{
    USLOSS_Sysargs sa;
 ...
 *
 */
int SemCreate(char *name, int value, int *semaphore)
{
    USLOSS_Sysargs sa;
...
int Protect(int page, int protection)
{
    USLOSS_Sysargs sa;
...
int Share(int pid, int source, int target)
{
    USLOSS_Sysargs sa;
...
int COW(int pid, int source, int target)
{
    USLOSS_Sysargs sa;
 ...
 *
 */
int HeapAlloc(int bytes, void **ptr)                           
{
    USLOSS_Sysargs sa;
 ...
 *
 */
int MboxCreate(int numslots, int slotsize, int *mid)
{
    USLOSS_Sysargs sa;
 ...
 *
 */
int MboxCondReceive(int mbox, void *msg, int *size)
{
    USLOSS_Sysargs 	sa;
